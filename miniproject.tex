...
{
    \fancyhead[L]{\small {Jayesh Unde}}    
    \fancyhead[C]{\fontsize{30}{10}\selectfont\textbf{Report using Latex}}
     \fancyhead[R]{\small {0801CS211049 }}
}
...
\begin{figure}[h]
 ...
 \thispagestyle{restpage}
      \begin{figure}[h]
      \begin{center}
      \includegraphics[width=0.9\textwidth]{output5.png}
      \end{center}
      \end{figure}
 ...
 \thispagestyle{restpage}
   \section{Profiling}
      \begin{figure}[h]
      \begin{center}
      \includegraphics[width=1.0\textwidth]{profiling1.png}
      \end{center}
      \end{figure}
      \begin{figure}[h]
      \begin{center}
      \includegraphics[width=1.0\textwidth]{profiling2.png}
      \end{center}
      \end{figure}
 ...
 \begin{figure}[h]
      \begin{center}
      \includegraphics[width=1.0\textwidth]{d1.png}
      \end{center}
      \end{figure}
      \vspace*{10mm}
       \begin{figure}[h]
